package com.wyf.designcreate.mapper;
...
/**
* @author 15502
* @description 针对表【message_summary.sql(会话摘要表（与消息表分离存储）)】的数据库操作Mapper
* @createDate 2026-04-06 14:40:04
* @Entity com.wyf.designcreate.model.entity.MessageSummary
*/
